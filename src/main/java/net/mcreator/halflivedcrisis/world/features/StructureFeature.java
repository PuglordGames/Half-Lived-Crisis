package net.mcreator.halflivedcrisis.world.features;
...
import net.mcreator.halflivedcrisis.world.features.configurations.StructureFeatureConfiguration;
...
public class StructureFeature extends Feature<StructureFeatureConfiguration> {
	public static final DeferredRegister<Feature<?>> REGISTRY = DeferredRegister.create(ForgeRegistries.FEATURES, HalfLivedCrisisMod.MODID);
