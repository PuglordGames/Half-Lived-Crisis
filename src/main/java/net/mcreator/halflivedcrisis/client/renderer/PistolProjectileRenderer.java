...
public class PistolProjectileRenderer extends EntityRenderer<PistolProjectileEntity> {
	...
	@Override
	public void render(PistolProjectileEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
