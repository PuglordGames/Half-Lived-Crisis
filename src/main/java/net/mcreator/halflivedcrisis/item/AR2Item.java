...
public class AR2Item extends Item implements GeoItem {
	...
	public void initializeClient(Consumer<IClientItemExtensions> consumer) {
		...
		consumer.accept(new IClientItemExtensions() {
			private final BlockEntityWithoutLevelRenderer renderer = new AR2ItemRenderer();
			...
			private static final HumanoidModel.ArmPose AR2Pose = HumanoidModel.ArmPose.create("AR2", false, (model, entity, arm) -> {
