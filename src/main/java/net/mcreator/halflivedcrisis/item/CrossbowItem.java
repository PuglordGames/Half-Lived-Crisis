...
import net.mcreator.halflivedcrisis.procedures.CrossbowRightclickedProcedure;
import net.mcreator.halflivedcrisis.procedures.CrossbowItemInHandTickProcedure;
import net.mcreator.halflivedcrisis.item.renderer.CrossbowItemRenderer;
...
public class CrossbowItem extends Item implements GeoItem {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		CrossbowRightclickedProcedure.execute(world, x, y, z, entity, itemstack);
		return ar;
	}
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		if (selected)
			CrossbowItemInHandTickProcedure.execute(entity);
	}
}
