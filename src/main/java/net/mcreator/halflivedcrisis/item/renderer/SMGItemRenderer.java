...
import net.mcreator.halflivedcrisis.item.model.SMGItemModel;
...
public class SMGItemRenderer extends GeoItemRenderer<SMGItem> {
	public SMGItemRenderer() {
		super(new SMGItemModel());
	}

	@Override
	public RenderType getRenderType(SMGItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
	...
	@Override
	public void actuallyRender(PoseStack matrixStackIn, SMGItem animatable, BakedGeoModel model, RenderType type, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, boolean isRenderer, float partialTicks, int packedLightIn,
	...
	@Override
	public void renderRecursively(PoseStack stack, SMGItem animatable, GeoBone bone, RenderType type, MultiBufferSource buffer, VertexConsumer bufferIn, boolean isReRender, float partialTick, int packedLightIn, int packedOverlayIn, float red,
	...
	@Override
	public ResourceLocation getTextureLocation(SMGItem instance) {
