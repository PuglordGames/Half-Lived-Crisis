...
import net.mcreator.halflivedcrisis.item.model.GaussGunItemModel;
...
public class GaussGunItemRenderer extends GeoItemRenderer<GaussGunItem> {
	public GaussGunItemRenderer() {
		super(new GaussGunItemModel());
	}

	@Override
	public RenderType getRenderType(GaussGunItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
	...
	protected GaussGunItem animatable;
	...
	@Override
	public void actuallyRender(PoseStack matrixStackIn, GaussGunItem animatable, BakedGeoModel model, RenderType type, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, boolean isRenderer, float partialTicks, int packedLightIn,
	...
	@Override
	public void renderRecursively(PoseStack stack, GaussGunItem animatable, GeoBone bone, RenderType type, MultiBufferSource buffer, VertexConsumer bufferIn, boolean isReRender, float partialTick, int packedLightIn, int packedOverlayIn, float red,
	...
	@Override
	public ResourceLocation getTextureLocation(GaussGunItem instance) {
