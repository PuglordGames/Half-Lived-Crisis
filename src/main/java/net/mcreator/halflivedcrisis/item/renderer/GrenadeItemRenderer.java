...
import net.mcreator.halflivedcrisis.item.model.GrenadeItemModel;
...
public class GrenadeItemRenderer extends GeoItemRenderer<GrenadeItem> {
	...
	@Override
	public RenderType getRenderType(GrenadeItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
	...
	protected GrenadeItem animatable;
	...
	@Override
	public void actuallyRender(PoseStack matrixStackIn, GrenadeItem animatable, BakedGeoModel model, RenderType type, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, boolean isRenderer, float partialTicks, int packedLightIn,
	...
	@Override
	public void renderRecursively(PoseStack stack, GrenadeItem animatable, GeoBone bone, RenderType type, MultiBufferSource buffer, VertexConsumer bufferIn, boolean isReRender, float partialTick, int packedLightIn, int packedOverlayIn, float red,
	...
	@Override
	public ResourceLocation getTextureLocation(GrenadeItem instance) {
