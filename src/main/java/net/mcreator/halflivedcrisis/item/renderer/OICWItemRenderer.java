...
import net.mcreator.halflivedcrisis.item.model.OICWItemModel;
...
public class OICWItemRenderer extends GeoItemRenderer<OICWItem> {
	public OICWItemRenderer() {
		super(new OICWItemModel());
	}

	@Override
	public RenderType getRenderType(OICWItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
	...
	@Override
	public void actuallyRender(PoseStack matrixStackIn, OICWItem animatable, BakedGeoModel model, RenderType type, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, boolean isRenderer, float partialTicks, int packedLightIn,
	...
	@Override
	public void renderRecursively(PoseStack stack, OICWItem animatable, GeoBone bone, RenderType type, MultiBufferSource buffer, VertexConsumer bufferIn, boolean isReRender, float partialTick, int packedLightIn, int packedOverlayIn, float red,
	...
	@Override
	public ResourceLocation getTextureLocation(OICWItem instance) {
