...
import net.mcreator.halflivedcrisis.item.model.AR2ItemModel;
...
public class AR2ItemRenderer extends GeoItemRenderer<AR2Item> {
	public AR2ItemRenderer() {
		super(new AR2ItemModel());
	}

	@Override
	public RenderType getRenderType(AR2Item animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
	...
	@Override
	public void actuallyRender(PoseStack matrixStackIn, AR2Item animatable, BakedGeoModel model, RenderType type, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, boolean isRenderer, float partialTicks, int packedLightIn,
	...
	@Override
	public void renderRecursively(PoseStack stack, AR2Item animatable, GeoBone bone, RenderType type, MultiBufferSource buffer, VertexConsumer bufferIn, boolean isReRender, float partialTick, int packedLightIn, int packedOverlayIn, float red,
	...
	@Override
	public ResourceLocation getTextureLocation(AR2Item instance) {
