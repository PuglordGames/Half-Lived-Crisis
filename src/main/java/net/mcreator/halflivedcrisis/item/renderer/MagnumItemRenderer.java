...
import net.mcreator.halflivedcrisis.item.model.MagnumItemModel;
...
public class MagnumItemRenderer extends GeoItemRenderer<MagnumItem> {
	public MagnumItemRenderer() {
		super(new MagnumItemModel());
	}

	@Override
	public RenderType getRenderType(MagnumItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
	...
	protected MagnumItem animatable;
	...
	@Override
	public void actuallyRender(PoseStack matrixStackIn, MagnumItem animatable, BakedGeoModel model, RenderType type, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, boolean isRenderer, float partialTicks, int packedLightIn,
	...
	@Override
	public void renderRecursively(PoseStack stack, MagnumItem animatable, GeoBone bone, RenderType type, MultiBufferSource buffer, VertexConsumer bufferIn, boolean isReRender, float partialTick, int packedLightIn, int packedOverlayIn, float red,
	...
	@Override
	public ResourceLocation getTextureLocation(MagnumItem instance) {
