...
import net.mcreator.halflivedcrisis.item.model.CrowbarItemModel;
...
public class CrowbarItemRenderer extends GeoItemRenderer<CrowbarItem> {
	...
	@Override
	public RenderType getRenderType(CrowbarItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
	...
	protected CrowbarItem animatable;
	...
	@Override
	public void actuallyRender(PoseStack matrixStackIn, CrowbarItem animatable, BakedGeoModel model, RenderType type, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, boolean isRenderer, float partialTicks, int packedLightIn,
	...
	@Override
	public void renderRecursively(PoseStack stack, CrowbarItem animatable, GeoBone bone, RenderType type, MultiBufferSource buffer, VertexConsumer bufferIn, boolean isReRender, float partialTick, int packedLightIn, int packedOverlayIn, float red,
	...
	@Override
	public ResourceLocation getTextureLocation(CrowbarItem instance) {
