...
import net.mcreator.halflivedcrisis.item.model.PistolItemModel;
...
public class PistolItemRenderer extends GeoItemRenderer<PistolItem> {
	...
	@Override
	public RenderType getRenderType(PistolItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
	...
	protected PistolItem animatable;
	...
	@Override
	public void actuallyRender(PoseStack matrixStackIn, PistolItem animatable, BakedGeoModel model, RenderType type, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, boolean isRenderer, float partialTicks, int packedLightIn,
	...
	@Override
	public void renderRecursively(PoseStack stack, PistolItem animatable, GeoBone bone, RenderType type, MultiBufferSource buffer, VertexConsumer bufferIn, boolean isReRender, float partialTick, int packedLightIn, int packedOverlayIn, float red,
	...
	@Override
	public ResourceLocation getTextureLocation(PistolItem instance) {
