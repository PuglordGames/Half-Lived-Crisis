...
import net.mcreator.halflivedcrisis.item.model.CrossbowItemModel;
...
public class CrossbowItemRenderer extends GeoItemRenderer<CrossbowItem> {
	public CrossbowItemRenderer() {
		super(new CrossbowItemModel());
	}

	@Override
	public RenderType getRenderType(CrossbowItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
	...
	protected CrossbowItem animatable;
	...
	@Override
	public void actuallyRender(PoseStack matrixStackIn, CrossbowItem animatable, BakedGeoModel model, RenderType type, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, boolean isRenderer, float partialTicks, int packedLightIn,
	...
	@Override
	public void renderRecursively(PoseStack stack, CrossbowItem animatable, GeoBone bone, RenderType type, MultiBufferSource buffer, VertexConsumer bufferIn, boolean isReRender, float partialTick, int packedLightIn, int packedOverlayIn, float red,
	...
	@Override
	public ResourceLocation getTextureLocation(CrossbowItem instance) {
