...
public class GravityGunItemRenderer extends GeoItemRenderer<GravityGunItem> {
	...
	@Override
	public RenderType getRenderType(GravityGunItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
	...
	protected GravityGunItem animatable;
	...
	@Override
	public void actuallyRender(PoseStack matrixStackIn, GravityGunItem animatable, BakedGeoModel model, RenderType type, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, boolean isRenderer, float partialTicks, int packedLightIn,
	...
	@Override
	public void renderRecursively(PoseStack stack, GravityGunItem animatable, GeoBone bone, RenderType type, MultiBufferSource buffer, VertexConsumer bufferIn, boolean isReRender, float partialTick, int packedLightIn, int packedOverlayIn, float red,
