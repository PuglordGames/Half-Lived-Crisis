...
public class GaussProjectileEntity extends AbstractArrow implements ItemSupplier {
	public static final ItemStack PROJECTILE_ITEM = new ItemStack(Blocks.AIR);

	public GaussProjectileEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(HalfLivedCrisisModEntities.GAUSS_PROJECTILE.get(), world);
	}

	public GaussProjectileEntity(EntityType<? extends GaussProjectileEntity> type, Level world) {
		super(type, world);
	}

	public GaussProjectileEntity(EntityType<? extends GaussProjectileEntity> type, double x, double y, double z, Level world) {
		super(type, x, y, z, world);
	}

	public GaussProjectileEntity(EntityType<? extends GaussProjectileEntity> type, LivingEntity entity, Level world) {
	...
	public static GaussProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
		GaussProjectileEntity entityarrow = new GaussProjectileEntity(HalfLivedCrisisModEntities.GAUSS_PROJECTILE.get(), entity, entity.level());
