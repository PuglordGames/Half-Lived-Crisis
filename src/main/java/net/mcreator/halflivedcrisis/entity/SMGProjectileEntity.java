...
public class SMGProjectileEntity extends AbstractArrow implements ItemSupplier {
	public static final ItemStack PROJECTILE_ITEM = new ItemStack(Blocks.AIR);

	public SMGProjectileEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(HalfLivedCrisisModEntities.SMG_PROJECTILE.get(), world);
	}

	public SMGProjectileEntity(EntityType<? extends SMGProjectileEntity> type, Level world) {
		super(type, world);
	}

	public SMGProjectileEntity(EntityType<? extends SMGProjectileEntity> type, double x, double y, double z, Level world) {
		super(type, x, y, z, world);
	}

	public SMGProjectileEntity(EntityType<? extends SMGProjectileEntity> type, LivingEntity entity, Level world) {
	...
	public static SMGProjectileEntity shoot(Level world, LivingEntity entity, RandomSource source) {
	...
	public static SMGProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
		SMGProjectileEntity entityarrow = new SMGProjectileEntity(HalfLivedCrisisModEntities.SMG_PROJECTILE.get(), entity, entity.level());
