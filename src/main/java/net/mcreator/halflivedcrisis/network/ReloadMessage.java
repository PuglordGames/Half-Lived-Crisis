...
import net.mcreator.halflivedcrisis.procedures.ReloadOnKeyPressedProcedure;
...
public class ReloadMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		HalfLivedCrisisMod.addNetworkMessage(ReloadMessage.class, ReloadMessage::buffer, ReloadMessage::new, ReloadMessage::handler);
	}
}
